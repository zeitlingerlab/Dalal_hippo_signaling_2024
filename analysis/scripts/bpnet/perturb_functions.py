import sys
sys.path.insert(0, f'/n/projects/kd2200/publication/bpnet/analysis/scripts/bpnet')
...
from plot_functions import plot_pred_motif_boxes, plot_nexus_prediction, plot_contrib_track, plot_contrib_motif_box
from data_format_functions import pred_npd_to_tidy_df, contrib_npd_to_df
