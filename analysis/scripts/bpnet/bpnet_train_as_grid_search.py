...
2. `python /n/projects/mw2098/shared_code/bpnet/bpnet_train_with_raw_grid_search.py [options]`
3. For help: `python /n/projects/mw2098/shared_code/bpnet/bpnet_train_with_raw_grid_search.py -h`
"""
