...
# opt$files<-"/n/projects/mw2098/analysis/bpnet/models/kb2009/bpnet/contrib/ZDT_mbt_default/bw/test_chr*.Dl.contrib.counts.bw"
# opt$bsgenome<-"BSgenome.Dmelanogaster.UCSC.dm6"
# opt$output<-"/n/projects/mw2098/analysis/bpnet/models/kb2009/bpnet/contrib/ZDT_mbt_default/bw/test.Dl.contrib.counts.bw"
